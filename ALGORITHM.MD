...
Utilize `Stack` to store the Tree Node alone the left path or right path, and pop up the Tree Node to access other part of the tree. Check `94. Binary Tree In-order Traversal` to have an inspiration!!!
